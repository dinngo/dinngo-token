...
/**
 * @title StateToken
 * @dev StandardToken modified with state and transfer permission.
 **/
contract StateToken is StandardToken, State, Pausable, Whitelist {
    ...
    function transfer(address _to, uint256 _value)
        public whenNotPaused whenTransferrable returns (bool) {
...
/**
 * @title CustomToken
 * @dev The customized token of Dinngo
 */
contract CustomToken is StateToken {
